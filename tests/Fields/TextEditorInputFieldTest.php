...
use Pgly\FormFields\Fields\TextEditorInputField;
use Pgly\FormFields\Options\HtmlFieldOptions;
use PHPUnit\Framework\TestCase;

class TextEditorInputFieldTest extends TestCase
{
	public function testRender()
	{
		...
		$field = new TextEditorInputField($options);
		...
		$expected_html .= '<div class="pgly-wps--field pgly-form--input pgly-form--texteditor" data-name="test_name">';
		$expected_html .= '<label class="pgly-wps--label">Test Label</label>';
		$expected_html .= '<div class="quill-wrapper"><div class="quill-editor">My New Value</div></div>';
	...
	public function testRenderWithDefaultValue()
	{
		...
		$expected_html .= '<div class="pgly-wps--field pgly-form--input pgly-form--texteditor" data-name="test_name">';
		$expected_html .= '<label class="pgly-wps--label">Test Label</label>';
		$expected_html .= '<div class="quill-wrapper"><div class="quill-editor">Test Value</div></div>';
		$expected_html .= '<span class="pgly-wps--badge pgly-wps-is-danger" style="margin-top: 6px; margin-right: 6px">Obrigatório</span>';
		$expected_html .= '<span class="pgly-wps--message"></span>';
		$expected_html .= '<p class="pgly-wps--description">Test Description</p>';
		$expected_html .= '</div>';
	...
	public function testRenderWithEmptyValue()
	{
		...
		$expected_html .= '<div class="pgly-wps--field pgly-form--input pgly-form--texteditor" data-name="test_name">';
		$expected_html .= '<label class="pgly-wps--label">Test Label</label>';
		$expected_html .= '<div class="quill-wrapper"><div class="quill-editor"></div></div>';
		$expected_html .= '<span class="pgly-wps--badge pgly-wps-is-danger" style="margin-top: 6px; margin-right: 6px">Obrigatório</span>';
		$expected_html .= '<span class="pgly-wps--message"></span>';
		$expected_html .= '<p class="pgly-wps--description">Test Description</p>';
		$expected_html .= '</div>';
