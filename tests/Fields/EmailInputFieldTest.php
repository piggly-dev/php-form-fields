...
use Pgly\FormFields\Fields\EmailInputField;
...
class EmailInputFieldTest extends TestCase
{
	public function testRender()
	{
		...
		$field = new EmailInputField($options);
		...
		$expected_html .= '<input id="test_name" name="test_name" type="email" value="" class="test-class" required="required">';
