...
use Pgly\FormFields\Fields\IntegerInputField;
use Pgly\FormFields\Options\HtmlFieldOptions;
use PHPUnit\Framework\TestCase;

class IntegerInputFieldTest extends TestCase
{
	public function testRender()
	{
		...
		$field = new IntegerInputField($options);
		...
		$expected_html .= '<input id="test_name" name="test_name" type="number" value="" class="test-class" required="required">';
