...
use Pgly\FormFields\Fields\PasswordInputField;
...
class PasswordInputFieldTest extends TestCase
{
	public function testRender()
	{
		...
		$field = new PasswordInputField($options);
		...
		$expected_html .= '<input id="test_name" name="test_name" type="password" value="" class="test-class" required="required">';
