...
use Pgly\FormFields\Fields\UrlInputField;
use Pgly\FormFields\Options\HtmlFieldOptions;
use PHPUnit\Framework\TestCase;

class UrlInputFieldTest extends TestCase
{
	public function testRender()
	{
		...
		$field = new UrlInputField($options);
		...
		$expected_html .= '<input id="test_name" name="test_name" type="url" value="" class="test-class" required="required">';
