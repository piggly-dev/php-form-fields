...
use Pgly\FormFields\Fields\TimeInputField;
use Pgly\FormFields\Options\HtmlFieldOptions;
use PHPUnit\Framework\TestCase;

class TimeInputFieldTest extends TestCase
{
	public function testRender()
	{
		...
		$field = new TimeInputField($options);
		...
		$expected_html .= '<input id="test_name" name="test_name" type="time" value="" class="test-class" required="required">';
